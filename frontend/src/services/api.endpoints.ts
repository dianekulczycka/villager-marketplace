...
export const endpoints = {
  ...
  admin: {
    ...
    byId: (id: number) => `${roots.admin}/id/${id}`,
    delete: (id: number) => `${roots.admin}/id/${id}/soft-delete`,
    restore: (id: number) => `${roots.admin}/id/${id}/restore`,
    ban: (id: number) => `${roots.admin}/id/${id}/ban`,
    unban: (id: number) => `${roots.admin}/id/${id}/unban`,
    unflag: (id: number) => `${roots.admin}/id/${id}/unflag`,
    promote: (id: number) => `${roots.admin}/id/${id}/promote-manager`,
    demote: (id: number) => `${roots.admin}/id/${id}/demote`,
  },
} as const;
